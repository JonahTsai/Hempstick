...
rtos_adc_data_type g_adc_data = {
	...
	.channel_mapping = {UINT8_MAX, 1,  2,  3, UINT8_MAX, UINT8_MAX,  UINT8_MAX, UINT8_MAX, UINT8_MAX, UINT8_MAX,  UINT8_MAX,  UINT8_MAX,  UINT8_MAX, UINT8_MAX, UINT8_MAX,  UINT8_MAX},
#endif
